# -*- coding: utf-8 -*-
"""
Created on Sat Oct 21 17:50:54 2017
...
for i in range(0,3):
    data = []
    url = 'https://secure.sos.state.or.us/orestar/cneSearch.do?cneSearchButtonName=search&cneSearchFilerCommitteeId=14060'
